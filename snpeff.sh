...
input_vcf="/scratch1/jlee0087/projects/exome_exercise/vcfs/threshold50.recal.marked.merged.NA12878.vcf"
output_name="/scratch1/jlee0087/projects/exome_exercise/vcfs/snpeff.threshold50.recal.marked.merged.NA12878.vcf"
